export default function SparklesIcon({width = "24px", height = "24px"}) {
    return (
        <svg fill="currentColor" width={width} height={height} viewBox="0 0 56 56" xmlns="http://www.w3.org/2000/svg">
